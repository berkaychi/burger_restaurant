...
export default function Login() {
  ...
  return (
    <div className="bg-secondary font-[sans-serif] min-h-screen flex flex-col items-center justify-center py-6 px-4">
      <div className="max-w-lg w-full border border-primary p-8 rounded-md bg-secondary">
        ...
        <form className="mt-12 space-y-4" onSubmit={handleSubmit}>
          <div className="relative flex items-center">
            <input
              ...
              type="text"
              required
              className="w-full text-sm text-gray-800 bg-gray-300 border-2 border-transparent focus:border-[#1E2772] px-4 py-3 rounded-md outline-none"
          ...
          <div className="!mt-6">
            <button type="submit" className="menu_btn w-full">
              Log in
            </button>
          </div>
        </form>
